    ...
    try {
      ...
      switch (error.code) {
        ...
        case 'auth/operation-not-allowed':
          description = "Email/password sign-up is not enabled for this app. Please contact support.";
          break;
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-sm shadow-2xl animate-in fade-in-50 duration-500">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>Sign up to start tracking your habits</CardDescription>
        </CardHeader>
        <CardContent>
